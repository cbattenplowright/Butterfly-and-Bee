...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        List<Book> books = new ArrayList<>(Arrays.asList(
                ...
                new Book("George Orwell", "1984", 43, 11, 30, 1949, 350,"/images/books/hp.jpg"),
                new Book("J.R.R. Tolkien", "The Lord of the Rings", 12, 11, 20, 1954, 1170,"/images/books/hp.jpg"),
                new Book("Agatha Christie", "Murder on the Orient Express", 533, 11, 10, 1934, 250,"/images/books/hp.jpg"),
                new Book("Khalid Hosseini", "The Kite Runner", 433, 11, 0, 2003, 370,"/images/books/hp.jpg")
        ));

        List<Movie> movies = new ArrayList<>(Arrays.asList(
                new Movie("Francis Ford Coppola", "The Godfather", 175, 12, 10, 9.2, 100,"/images/books/hp.jpg"),
                new Movie("Quentin Tarantino", "Pulp Fiction", 154, 18, 20, 8.9, 110,"/images/books/hp.jpg"),
                new Movie("Christopher Nolan", "Inception", 148, 12, 30, 8.8, 130,"/images/books/hp.jpg"),
                new Movie("Steven Spielberg", "Jurassic Park", 127, 7, 0, 8.1, 120,"/images/books/hp.jpg")
        ));

        List<Music> songs = new ArrayList<>(Arrays.asList(
                new Music("The Beatles", "Hey Jude", 5, 12, 100, "1970", 200,"/images/books/hp.jpg"),
                new Music("Queen", "Bohemian Rhapsody", 6, 12, 50, "1980", 210,"/images/books/hp.jpg"),
                new Music("Michael Jackson", "Billie Jean", 4, 12, 25, "2000", 190,"/images/books/hp.jpg"),
                new Music("Bob Marley", "No Woman, No Cry", 7, 12, 0, "2010", 180,"/images/books/hp.jpg")
        ));
